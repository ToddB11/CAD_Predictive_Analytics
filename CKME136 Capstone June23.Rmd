...
# When it is time to pull from Github, use the following example:
# FullSetB4<-read.csv(file="https://raw.githubusercontent.com/ToddB/master/data/Z-# Alizadeh sani MAIN dataset.csv",header=T,sep=",")

```{r}
FullSetB4 <- read.csv(file = "C:/Users/TGB/Documents/Ryerson/CKME 136/Data/ZAlizadeh_dataset.csv", header = T, sep = ",")
```
...
# Double checking whether all observations are complete (no missing data):
```{r}
