...
# TCP: For a one unit increase in TCP, the log odds of being diagnosed with Coronary Artery Disease increases by 3.5489
# ACP: For a one unit increase in ACP, the log odds of being diagnosed with Coronary Artery Disease increases by 0.2876
# RWMA: For a one unit increase in RWMA, the log odds of being diagnosed with Coronary Artery Disease increases by 2.0681
# EF: For a one unit increase in EF, the log odds of being diagnosed with Coronary Artery Disease DECREASES by 1.0245
# NCP: For a one unit increase in NCP, the log odds of being diagnosed with Coronary Artery Disease DECREASES by 2.6333
# Age: For a one unit increase in Age, the log odds of being diagnosed with Coronary Artery Disease increases by 1.2347
# HTN: For a one unit increase in HTN, the log odds of being diagnosed with Coronary Artery Disease increases by 1.5145
# DM: For a one unit increase in DM, the log odds of being diagnosed with Coronary Artery Disease increases by 1.8319
...
```{r}
RFstability <- data.frame(Accuracy=c(0.8800, 0.8800, 0.8667, 0.8800, 0.8800, 0.8933, 0.8800), Sensitivity=rep(0.9630, 7), Specificity=c(0.6667, 0.6667, 0.6190, 0.6667, 0.6667, 0.7143, 0.6667))
...
plot(1:nrow(RFstability), 1:nrow(RFstability), pch="", 
		...
		ylim=c(.6,1), bty="n", xlim=c(1,xmax), main="Random Forest Stability Results")
for (i in seq(.6,1,by=.025)) {
...
axis(side=2, at=seq(.6,1,by=.025), tick=TRUE, 
		las=TRUE, labels=paste(seq(.6,1,by=.025)))
...
```{r}
RFstability <- data.frame(Accuracy=c(0.8533, 0.8800, 0.8800, 0.8800, 0.8533, 0.8533, 0.8800), Sensitivity=c(0.8519, 0.8889, 0.8889, 0.8889, 0.8519, 0.8519, 0.8889 ), Specificity=rep(0.8571, 7))
rownames(RFstability) <- c(3,5,7,10,15,20,25)
RFstability
...
plot(1:nrow(RFstability), 1:nrow(RFstability), pch="", 
		xlab="nFolds", ylab=NA, xaxt="n", yaxt="n", 
		ylim=c(.8,1), bty="n", xlim=c(1,xmax), main="Naive Bayes Stability Results")
for (i in seq(.8,1,by=.02)) {
	lines(1:nrow(RFstability), rep(i,nrow(RFstability)), col="gray69")
}
for (i in 1:ncol(RFstability)) {
...
axis(side=2, at=seq(.8,1,by=.02), tick=TRUE, 
		las=TRUE, labels=paste(seq(.8,1,by=.02)))
...
```{r}
RFstability <- data.frame(Accuracy=c(0.8533, 0.8533, 0.8533, 0.8533, 0.8800, 0.8667, 0.8800), Sensitivity=c(0.9444, 0.9630, 0.9444, 0.9630, 0.9444, 0.9630, 0.9444), Specificity=c(0.6190, 0.5714, 0.6190, 0.5714, 0.7143, 0.6190, 0.7143))
rownames(RFstability) <- c(3,5,7,10,15,20,25)
RFstability
...
plot(1:nrow(RFstability), 1:nrow(RFstability), pch="", 
		xlab="nFolds", ylab=NA, xaxt="n", yaxt="n", 
		ylim=c(.5,1), bty="n", xlim=c(1,xmax), main="Logistic Regression Stability Results")
for (i in seq(.5,1,by=.025)) {
	lines(1:nrow(RFstability), rep(i,nrow(RFstability)), col="gray69")
}
for (i in 1:ncol(RFstability)) {
...
axis(side=2, at=seq(.5,1,by=.025), tick=TRUE, 
		las=TRUE, labels=paste(seq(.5,1,by=.025)))
