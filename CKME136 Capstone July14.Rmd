...
```{r}
RFstability <- data.frame(Accuracy=c(0.9200, 0.9200, 0.9333, 0.9067, 0.9067, 0.9200, 0.9200), Sensitivity=c(0.8889, 0.8889, 0.9074, 0.8704, 0.8889, 0.8889, 0.8889), Specificity=rep(1.0, 1.0, 1.0, 1.0, 0.9524, 1.0, 1.0))
rownames(RFstability) <- c(3,5,7,10,15,20,25)
RFstability
...
```{r}
RFstability <- data.frame(Accuracy=rep(0.9333,7), Sensitivity=rep(0.9630,7), Specificity=rep(0.8571,7))
rownames(RFstability) <- c(3,5,7,10,15,20,25)
RFstability
