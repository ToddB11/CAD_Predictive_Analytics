...
rfFit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'rf', returnResamp = "final", trControl = trainControl(method = "repeatedcv", number = 10, repeats = 3, sampling = "smote"))
rfFit
plot(rfFit)
...
NBfit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'nb', returnResamp = "final", trControl = trainControl(method = "repeatedcv", number = 10, repeats = 3, sampling = "smote"))
NBfit
...
LRFit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'glm', family = "binomial", trControl = trainControl(method = "repeatedcv", number = 10, repeats = 3, sampling = "smote"))
LRFit
...
ENCntrl <- trainControl(method = "LOOCV", number = 10, savePredictions = "all", search = "grid", sampling = "smote")
