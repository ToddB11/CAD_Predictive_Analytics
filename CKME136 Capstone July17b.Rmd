...
#TenVars2
```
#### Checking on feature selection using the (hybrid) Autospearman function:  Currently UNABLE to install Rnalyica package - and hence cannot find/load 'AutoSpearman' function. Installation corrupted system.
```{r}
...
NBfit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'nb', returnResamp = "final")
NBfit
...
LRFit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'glm', family = "binomial")
LRFit
...
RFmodel <- train(AllvFtrain[,predictors],AllvFtrain[,outcomeName], method='rf',tuneLength = 3)

NBmodel <- train(AllvFtrain[,predictors],AllvFtrain[,outcomeName], method='nb',tuneLength = 3)

LRmodel <- train(AllvFtrain[,predictors],AllvFtrain[,outcomeName], method='glm',tuneLength = 3)
