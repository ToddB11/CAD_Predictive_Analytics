...
rfFit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'rf', returnResamp = "final", tuneLength = 5, trControl = trainControl(method = "repeatedcv", number = 10, repeats = 10, sampling = "smote", allowParallel=TRUE))
rfFit
plot(rfFit)
...
NBfit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'nb', returnResamp = "final", tuneLength = 5, trControl = trainControl(method = "repeatedcv", number = 10, repeats = 10, sampling = "smote", allowParallel=TRUE))
NBfit
...
LRFit <- train(AllvFtrain[,predictors], AllvFtrain[,outcomeName], method = 'glm', family = "binomial", tuneLength = 5, trControl = trainControl(method = "repeatedcv", number = 10, repeats = 10, sampling = "smote", allowParallel=TRUE))
LRFit
...
RFmodel <- train(AllvFtrain[,predictors],AllvFtrain[,outcomeName], method='rf',tuneLength = 3, trControl = ENCntrl)

NBmodel <- train(AllvFtrain[,predictors],AllvFtrain[,outcomeName], method='nb',tuneLength = 3, trControl = ENCntrl)

LRmodel <- train(AllvFtrain[,predictors],AllvFtrain[,outcomeName], method='glm',tuneLength = 3, trControl = ENCntrl)
